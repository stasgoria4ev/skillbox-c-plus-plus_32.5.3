...
PROTOBUF_CONSTEXPR Company::Company(
  ...
  , /*decltype(_impl_.implementationofforeigneconomicactivity_)*/ false
} {}
...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.implementationofforeigneconomicactivity_),
    3,
    0,
    1,
    2,
...
class Company::_Internal {
 public:
  ...
  static void set_has_implementationofforeigneconomicactivity(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.implementationofforeigneconomicactivity_) {}
  };
  ...
  ::memcpy(&_impl_.yearoffoundation_, &from._impl_.yearoffoundation_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.implementationofforeigneconomicactivity_) -
    reinterpret_cast<char*>(&_impl_.yearoffoundation_)) + sizeof(_impl_.implementationofforeigneconomicactivity_));
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.yearoffoundation_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&_impl_.implementationofforeigneconomicactivity_) -
        reinterpret_cast<char*>(&_impl_.yearoffoundation_)) + sizeof(_impl_.implementationofforeigneconomicactivity_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 40)) {
          _Internal::set_has_implementationofforeigneconomicactivity(&has_bits);
          _impl_.implementationofforeigneconomicactivity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
::uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        1, this->_internal_yearoffoundation(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        5, this->_internal_implementationofforeigneconomicactivity(), target);
  }
...
void Company::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.implementationofforeigneconomicactivity_ = from._impl_.implementationofforeigneconomicactivity_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.implementationofforeigneconomicactivity_)
      + sizeof(Company::_impl_.implementationofforeigneconomicactivity_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.yearoffoundation_)>(
